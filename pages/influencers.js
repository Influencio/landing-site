    ...
    <Layout global={global} pageContext={pageContext}>
      ...
      <div className='flex flex-col items-center justify-center h-screen'>
        <div className='w-10/12 max-w-screen-md space-y-6 flex flex-col items-center'>
          ...
          <h1 className='text-6xl uppercase text-center'>the future of the influencer industry</h1>
          <h2 className='text-2xl text-gray-400 text-center'>Content creator, SoMe Consultant, Influencer, Blogger, you name it - our community is for all the creators. Join the first professional community for influencers and help change the perception of the industry. </h2>
